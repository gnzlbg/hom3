////////////////////////////////////////////////////////////////////////////////
/// \file \brief This file implements the debugging interface
...
/// \brief Prints value of arguments using debug::dout if ENABLE_DBG_ is set
...
/// \endcode
#define DBG_IF(pred,...) do { DOUT_IF(pred,ENABLE_DBG_,"#",__VA_ARGS__); } while (false)

/// \brief Prints the name _and_ value of the variables using debug::dout if
...
#define DBGV_IF(pred,...) do { DOUTV_IF(pred,ENABLE_DBG_,"#",__VA_ARGS__); } while (false)


/// \brief Prints "In _function_name_" (used at function entrance)
#define TRACE_IN_()                                                     \
  do {                                                                  \
    DBG("# -------------------------------------------------------\n"); \
...
/// \brief Prints "In _function_name_" and arguments (used at function
...
/// \brief Prints "Out _function_name_" (used at function exit)
#define TRACE_OUT()                                                     \
  do {                                                                  \
